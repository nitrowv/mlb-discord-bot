teamList = [
{'id': 109, 'name': 'Arizona Diamondbacks', 'teamCode': 'ari', 'fileCode': 'ari', 'teamName': 'D-backs', 'locationName': 'Phoenix', 'shortName': 'Arizona'}, 
...
{'id': 145, 'name': 'Chicago White Sox', 'teamCode': 'cha', 'fileCode': 'cws', 'teamName': 'White Sox', 'locationName': 'Chicago', 'shortName': 'Chi White Sox'}, 
{'id': 113, 'name': 'Cincinnati Reds', 'teamCode': 'cin', 'fileCode': 'cin', 'teamName': 'Reds', 'locationName': 'Cincinnati', 'shortName': 'Cincinnati'}, 
{'id': 114, 'name': 'Cleveland Guardians', 'teamCode': 'cle', 'fileCode': 'cle', 'teamName': 'Guardians', 'locationName': 'Cleveland', 'shortName': 'Cleveland'}, 
...
{'id': 118, 'name': 'Kansas City Royals', 'teamCode': 'kca', 'fileCode': 'kc', 'teamName': 'Royals', 'locationName': 'Kansas City', 'shortName': 'Kansas City'}, 
{'id': 108, 'name': 'Los Angeles Angels', 'teamCode': 'ana', 'fileCode': 'laa', 'teamName': 'Angels', 'locationName': 'Anaheim', 'shortName': 'LA Angels'}, 
{'id': 119, 'name': 'Los Angeles Dodgers', 'teamCode': 'lan', 'fileCode': 'lad', 'teamName': 'Dodgers', 'locationName': 'Los Angeles', 'shortName': 'LA Dodgers'}, 
{'id': 146, 'name': 'Miami Marlins', 'teamCode': 'mia', 'fileCode': 'mia', 'teamName': 'Marlins', 'locationName': 'Miami', 'shortName': 'Miami'}, 
...
{'id': 135, 'name': 'San Diego Padres', 'teamCode': 'sdn', 'fileCode': 'sd', 'teamName': 'Padres', 'locationName': 'San Diego', 'shortName': 'San Diego'}, 
{'id': 137, 'name': 'San Francisco Giants', 'teamCode': 'sfn', 'fileCode': 'sf', 'teamName': 'Giants', 'locationName': 'San Francisco', 'shortName': 'San Francisco'}, 
...
{'id': 139, 'name': 'Tampa Bay Rays', 'teamCode': 'tba', 'fileCode': 'tb', 'teamName': 'Rays', 'locationName': 'St. Petersburg', 'shortName': 'Tampa Bay'}, 
